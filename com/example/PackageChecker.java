...
public final class PackageChecker {
  ...
  /**
   * Master method that gets all user input. Returns a boolean value to indicate successful
   * operation.
   *
  ...
  /**
   * Simple method that generates a titled list of options from an array of strings.
   *
   * @param title passed.
  ...
  /**
   * Method that gets the user's choice from a list. It accepts user input in the form of an integer
   * or string and performs comparisons accordingly.
   *
  ...
  /**
   * Method that checks if the package can be loaded. It converts the units provided by the user
   * into kilograms and centimeters and checks if the package can be loaded.
   *
   * @return returnMessage.
   */
